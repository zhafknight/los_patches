...
The pack therefore addresses the core old-kernel, cgroup, and other LineageOS 23.2 compatibility requirements, but those three components may still need to be ported separately if your device requires them.
